          ...
          <div className="row">
            ...
            <div className="col-xxl-5 col-xl-5 col-lg-5 col-md-5">
              <div className="service__top-text text-anim">
                <p>
                  <span>Grow your brand and achieve more:</span>{" "}
                  We combine top-notch IT solutions with strategic marketing to launch, manage, and optimize your online presence.
                </p>
              </div>
            </div>
                ...
                <div className="service__list" ref={serviceList}>
                  ...
                  >
                    <div className="service__item animation_home1_service">
                      ...
                      <div className="service__text">
                        <p>
                          <strong>E-commerce, Landing Pages, Advertising and more: </strong> 
                          We build beautiful & professional Web / Mobile apps that users love
                        </p>
                      </div>
                  ...
                  >
                    <div className="service__item  animation_home1_service">
                      ...
                      <div className="service__text">
                        <p>
                        <strong>Level up your online presence</strong>. We manage your digital marketing so you can focus on what matters most
                    ...
                    <div className="service__item  animation_home1_service">
                      ...
                      <div className="service__text">
                        <p>
                          ...
                          <strong> We transform data into clear stories that fuel smarter decisions</strong>
                        </p>
                      </div>
                      <div className="service__link">
                        <p>
                  ...
                  >
                    <div className="service__item  animation_home1_service">
                      ...
                      <div className="service__text">
                        <p>
                          <strong>Cloud & Software Solutions</strong> Work from anywhere, work smarter. Secure and scalable cloud computing to power your global ambitions.
                        </p>
                      </div>
                      <div className="service__link">
                        <p>
