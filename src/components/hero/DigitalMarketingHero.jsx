            ...
            <div className="col-xxl-12">
              <div className="hero__inner-3">
                <div className="sec-title-wrapper">
                  <h2 className="sec-sub-title">IT, Creative & Marketing</h2>
                ...
                <div className="hero__text-3">
                  <p className="hero__text-animation" ref={heroTextAnim}>
                    <strong>All-in-one Growth. Streamline your success with our comprehensive IT, Creative & Marketing services</strong>
                  </p>
                </div>
